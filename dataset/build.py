...
def build_dataset(is_train, test_mode, args):
    if is_train:
        mode = 'train'
        anno_path = os.path.join(args.data_path, '/mnt/data/quangtungbk/Continuous-Action-Recognition-v2/train_clip_front.csv')
    elif test_mode:
        mode = 'test'
        if args.data_set != "Ego-Gesture":
            anno_path = os.path.join(args.data_path, 'test_clip_rear.csv')
        else:
            anno_path = os.path.join(args.data_path, 'test_clip_rear.csv')
    else:
        mode = 'validation'
